Feature: Delete a Legal Entity wit individuals
  ...
  Scenario Outline: Delete a Legal Entity with Individuals
    ...
    Examples:
      ...
      |      /     |       52       |     200      | Motorola & Tecnologias | Motorola    | 07831645000115 | true   | Rua Tres                          | 86     | Leme                  | São Paulo | 17135610 | true | Fernando Braga  | 94276982413 | 216299913 | Alice Ribeiro   | 1978-09-04 | true    | Rua do Rosário      | 874     | Lages        | Santa Catarina      | 88502240 | true  |
