Feature: Delete a Legal Entity without individuals
  ...
  Scenario Outline: Delete a Legal Entity without Individuals
    ...
    Examples:
      ...
      |      /     |       46       |     200      | Asus & Tecnologias    | ASUS        | 35528978000105 | true   | Rua Quatro                        | 87     | Bauru               | São Paulo | 17035610 | true |
      |      /     |     1000       |     200      | Dell computadores     | DELL        | 72681386000155 | true   | Rua Marquês de Maricá             | 45     | São José dos Campos | São Paulo | 12234400 | true |
